...
class OnboardingVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        slides = [
            ...
            OnboardingSlide(title: "Bisiklet ve Diğer Taşıtlar İçin De Uygun!", description: "Koş veya Herhangi Bir Taşıtla Koşuyu Başlat. Başlangıç ve bitiş noktaları arasında süren, tempon ve uzaklığın hesaplanıyor!", image: #imageLiteral(resourceName: "woman2")),
            OnboardingSlide(title: "Sana Verilen Önerilere Uy ve Başarıyı Yakala!", description: "Beslenme, koşu ile ilgili temel bilgiler, beslenme ve daha fazla öneri seni bekliyor. Haydi başlayalım!", image: #imageLiteral(resourceName: "cak1"))
        ]
